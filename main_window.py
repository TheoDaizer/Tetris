...
from containers import Container, MenuContainer, SinglePlayerContainer, HotSeatContainer

CONTAINERS = {'menu': MenuContainer, 'sp': SinglePlayerContainer, 'hs': HotSeatContainer}
